...
namespace PinotageTodo.Tests.Controllers.TodosControllerTests
{
    public partial class TodosControllerTests
    {
        ...
        public void GetAll_Throws_InvalidOperationException_If_A_Valid_UserId_Cannot_Be_Found_In_Claims(string userId)
        {
            // Arrange
            _objectUnderTest.UserId = () => { return userId; };
        ...
        [Fact]
        public void GetAll_Returns_Empty_Enumerable_If_TodoRepository_GetAll_Returns_Null()
        {
            // Arrange
        ...
        [Fact]
        public void GetAll_Returns_Empty_Enumerable_If_TodoRepository_GetAll_Returns_Empty_List()
        {
            // Arrange
        ...
        [Fact]
        public void GetAll_Returns_TodoApiModel_For_Each_TodoDataModel_Returned_From_TodoRepository_GetAll()
        {
            // Arrange
            var repositoryResult = new List<TodoDataModel>()
            {
